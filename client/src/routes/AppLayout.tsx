      ...
      <div className="flex min-w-0 flex-1 flex-col">
        <header className="flex items-center gap-3 border-b border-line bg-surface px-4 py-3 sm:px-6">
          ...
          <button
            ...
            className="ml-auto flex shrink-0 items-center gap-2 rounded-lg px-3 py-2 font-display text-sm font-medium text-ink-muted transition-colors hover:bg-surface-2 hover:text-ink"
          >
